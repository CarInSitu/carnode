...
SmartAudio::SmartAudio(const int rxPin, const int txPin) : _rxPin(rxPin), _txPin(txPin), _softSerial(rxPin, txPin) {
}
...
uint8_t SmartAudio::crc8(const uint8_t* ptr, uint8_t len) {
